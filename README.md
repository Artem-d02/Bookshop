...
This project is written according to the TDD approach. The tests were written for all functionality except trivial getters (setters that return a specific class field). Codecov was used to cover the code.
